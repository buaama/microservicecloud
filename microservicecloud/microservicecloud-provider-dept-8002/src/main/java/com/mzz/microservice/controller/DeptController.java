...
public class DeptController {
    ...
    {
        System.out.println("8002");return deptServiceImp.list();
    }
    ...
    public Object discovery()
    {
        ...
        List<ServiceInstance> serviceInstances=discoveryClient.getInstances("MICROSERVICECLOUD-DEPT2");//寻找叫做"MICRESERVICECLOUD-DEPT"的服务
